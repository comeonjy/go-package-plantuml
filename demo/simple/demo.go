...
import (
	"github.com/comeonjy/go-package-plantuml/codeanalysis"
...
func main() {
	...
	//	CodeDir: "/appdev/go-demo/src/github.com/comeonjy/go-package-plantuml/testdata/a",
	...
	config := codeanalysis.Config{
		CodeDir: "/appdev/go-demo/src/github.com/comeonjy/go-package-plantuml/testdata/uml",
		GopathDir : "/appdev/go-demo",
	}
